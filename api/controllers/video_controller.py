    ...
    def post(self, current_user, **kwargs):
        ...
        def download_and_process_video():
            ...
            if processor is not None:
                print("processing")
                output_filepath = processor.process_video(filename, folder_path, video_id, video_found["language"], sub)
            ...
            try:
                ...
                ns_log(video_controller, f"Error deleting temporary folder {folder_path}:" + str(e), logging.CRITICAL)
