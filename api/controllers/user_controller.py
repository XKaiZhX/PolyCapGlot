...
from models.user_models import (
    user_model, 
    user_update_username_model, 
    user_password_model, 
    user_dto_public_model
)

# Instancia del servicio de usuario
user_service = UserService()

# Creación del namespace para los controladores de usuario
...
class UserList(Resource):
    ...
    @user_controller.marshal_with(user_dto_public_model)
    def get(self):
        '''
    ...
    @user_controller.response(400, "Email already exists")
    ...
    def post(self):
        ...
        if user_service.register(data["username"], data["email"], data["password"]):
            return data
        user_controller.abort(400, "Email already exists")
