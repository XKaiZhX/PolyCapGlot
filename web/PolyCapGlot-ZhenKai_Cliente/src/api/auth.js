...
export const UpdateUsernameRequest = user => axios.put(API + '/user/upadte/username', user)
export const UpdatePasswordRequest = user => axios.put(API + '/user/update/password', user)
export const DeleteUserRequest = email => axios.delete(API + '/user/' + email)
